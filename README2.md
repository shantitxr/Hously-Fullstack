...
[Shanti Teixeira- YFE466 video](https://)

## Statement

Student's name: Shanti Teixeira
Student's Neptun code: YFE466
...
- [ ] Logged‑in users cannot access protected data belonging to other users
