  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="bg-white rounded-2xl p-6 shadow-md">
      <div class="flex items-center justify-between mb-4">
        ...
        <span class="text-sm text-green-500 bg-green-50 px-2 py-1 rounded-lg">+2 this month</span>
      </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-md">
      <div class="flex items-center justify-between mb-4">
        ...
        <span class="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded-lg">+1 this week</span>
      </div>
