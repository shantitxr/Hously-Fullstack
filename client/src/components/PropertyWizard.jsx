...
// ---------- helpers ----------
// Works both embedded in Blade (data-token) and standalone React app (localStorage)
const token = () =>
  document.getElementById("property-wizard")?.dataset?.token ?? localStorage.getItem("hously_token") ?? "";
